          ...
          <div className="flex flex-col sm:flex-row justify-between">
            ...
            <div className="flex flex-col basis-1/2">
              <input
                ...
                className="p-1.5 border bg-green-100 rounded focus:outline outline-green-700"
              />
              <span
                id="title-error"
          ...
          <div className="flex flex-col sm:flex-row justify-between">
            ...
            <div className="flex flex-col basis-1/2">
              <textarea
                ...
                className="p-1.5 border bg-green-100 rounded focus:outline outline-green-700 w-full resize-none"
              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-1 justify-between">
                  <input
                    ...
                    className="p-1.5 border bg-green-100 rounded focus:outline outline-green-700 w-full"
                  />
                  <Button
                    content={"Add"}
